  ...
  return (
    <>
      <main className="flex flex-col lg:flex-row items-center min-h-full p-5 lg:py-0 gap-5 bg-gray-200">
        ...
        <section className="w-full lg:w-4/7 h-full flex flex-col rounded-xl animate-slide-in custom-scroll overflow-y-auto">
          <div className="w-full space-y-4 sm:space-y-4">
            ...
            {/* Rincian Kebutuhan Masa Depan & Sisa Target Dana */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-7">
              <div className="border rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 bg-white border-slate-100 shadow-sm">
                <h1 className="font-bold text-md  sm:text-lg mb-3">Rincian Kebutuhan Masa Depan</h1>

                <div className="flex flex-col gap-3">
                  <div className="ring-2 ring-slate-300/30 shadow-md px-3 py-3 sm:py2 rounded-xl bg-slate-100">
                    <h1 className="text-xs font-bold tracking-wide text-gray-500">UANG PANGKAL</h1>
                    <p className="text-md font-extrabold tracking-wide">Rp 56.000.000</p>
                  </div>

                  <div className="ring-2 ring-slate-300/30 shadow-md px-3 py-3 sm:py2 rounded-xl bg-slate-100">
                    <h1 className="text-xs font-bold tracking-wide text-gray-500">TOTAL SPP</h1>
                    <p className="text-md font-extrabold tracking-wide">Rp 189.000.000</p>
                  </div>
                </div>

                <div className="flex justify-between items-center mt-4">
                  <p className="text-xs text-gray-600">Durasi Pendidikan</p>
                  <p className="text-sm font-bold">4 Tahun (8 Semester)</p>
                </div>
              </div>

              <div className="border rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 bg-white border-slate-100 shadow-sm flex flex-col gap-4 sm:gap-0 sm:justify-between">
                <div>
                  <h1 className="font-bold text-md  sm:text-lg mb-1">Sisa Target Dana</h1>
                  <p className="text-xs sm:text-sm text-slate-500 w-8/10 sm:w-full">
                    Jumlah kekurangan yang harus dipenuhi dalam periode investasi.
                  </p>
                </div>

                <h1 className="text-2xl sm:text-3xl font-bold">Rp 11.220.000.000</h1>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 shadow-sm border border-slate-100 select-none">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
                <div className="border border-slate-200 hover:border-[#2b4eff] rounded-xl p-4 sm:p-5 shadow-md hover:ring-4 hover:ring-[#2b4eff]/10 transition-all duration-200">
                  ...
                  <p className="text-base sm:text-lg font-bold text-slate-900 mb-0.5 sm:mb-1">Rp 5.5jt – 6.6jt</p>
